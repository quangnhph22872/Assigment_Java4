...
<div class="col-12 mt-5">
    <div class="row">
        <div class="col-6">
            <a href="/ASM_war_exploded/san-pham/create" class="btn btn-success">Thêm mới</a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-secondary"
                           href="/ASM_war_exploded/san-pham/edit?ma=${ sp.ma }">Cập nhật</a>
                    </td>
                    <td>
                        <a class="btn btn-danger"
                           href="/ASM_war_exploded/san-pham/delete?ma=${ sp.ma }">Xóa</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
